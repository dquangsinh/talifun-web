...
namespace Talifun.Web
{
    public static class FileHelper
    {
        ...
        /// </remarks>
        public static FileStream OpenFileStream(FileInfo fileInfo, int retry, FileMode fileMode, FileAccess fileAccess, FileShare fileShare)
        {
            var delay = 0;
        ...
        /// specified number of retries.
        /// </remarks>
        public static StreamReader OpenTextStreamReader(FileInfo fileInfo, int retry)
        {
            var delay = 0;
