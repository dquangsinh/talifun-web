...
{
    public sealed class FileExtensionDefaultElement : NamedConfigurationElement
    {
        ...
        static FileExtensionDefaultElement()
        {
            properties.Add(name);
        ...
        /// </summary>
        [ConfigurationProperty("maxMemorySize", IsRequired = false, DefaultValue = 50000L)]
